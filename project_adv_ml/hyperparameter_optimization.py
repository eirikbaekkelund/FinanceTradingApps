...
class HyperparameterOptimizationNBEATS:
    ...
    """
    def __init__(self, model, input_length, output_length, train_target, train_past_cov, val_target_input, val_past_cov, seed=42):
        self.model = model
        self.input_length = input_length
        self.output_length = output_length
        self.train_target = train_target
        self.train_past_cov = train_past_cov
        self.val_target_input = val_target_input
    ...
    @staticmethod
    def objective_nbeats(self, params, train_target, train_past_cov, test_target, test_past_cov):
        """ 
    ...
    def optimize(self, n_calls=50):
        ...
        def objective(num_stacks, num_blocks, layer_width, n_epochs, nr_epochs_val_period):
            ...
            return self.objective_nbeats(params, self.input_length, self.output_length, self.train_target, self.train_past_cov, self.val_target_input, self.val_past_cov, self.seed)
